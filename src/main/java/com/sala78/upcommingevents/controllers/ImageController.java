...
import com.sala78.upcommingevents.message.ResponseFile;
import com.sala78.upcommingevents.message.ResponseMessage;
...
@Controller
@CrossOrigin("http://localhost:8081")///mirar esto
